      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
          <div className="max-w-2xl">
            <p className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-[#AE2580]">
              What We Treat
            </p>

            <h2 className="text-4xl font-bold leading-tight text-[#252525] md:text-5xl">
              Treatment For Your
              <br />
              <span className="text-[#AE2580]">Movement & Comfort</span>
            </h2>
          </div>
          ...
          {treatments.map((treatment) => (
            ...
            >
              ...
              <div className="relative mt-10">
                <h3 className="text-2xl font-bold text-[#252525] transition-colors duration-300 group-hover:text-white">
                  {treatment.title}
                </h3>

                <p className="mt-4 max-w-sm text-sm leading-7 text-gray-500 transition-colors duration-300 group-hover:text-white/65">
